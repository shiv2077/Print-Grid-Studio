        ...
        <div className="v2-wrap v2-hero__grid">
          <div>
            ...
            <h1 className="v2-display-xl v2-hero__title">
              Upload a model.<br />See the <span className="v2-accent">real price</span>.<br />Print it.
            </h1>
          ...
          <div>
            <HeroVisual />
            <div className="v2-caliper" aria-hidden="true">
              <span>0</span>
              <span className="v2-caliper__line" />
              <span>256&nbsp;mm build</span>
            </div>
          </div>
        </div>
      </header>
